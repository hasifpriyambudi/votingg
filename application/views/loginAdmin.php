...
<body>
	<div class="container">
						...
						<form id="logForm">
							<fieldset>
								<div class="form-group">
									<input class="form-control" autocomplete="off" placeholder="Username" type="text" id="user" name="user">
								</div>
								<div class="form-group">
									<input class="form-control" autocomplete="off" placeholder="Password" type="password" id="pass" name="pass">
								</div>
		...
		<center><div class="card-footer text-muted">
			user: admin</p>
			pass: admin</p>
			alamat login pemilih <a href="<?php echo base_url();?>login/">disini</a>.
		</div></center>
	</div>
	...
	$(document).ready(function(){
		...
		$('#logForm').submit(function(e){
			...
			var login = function(){
				$.ajax({
					type: 'POST',
					url: url + 'login_admin/loginAdmin/',
					dataType: 'json',
					data: user,
